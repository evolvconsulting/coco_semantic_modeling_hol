## 1. Install Cortex Code if it's missing
...
## 3. Install Python if it's missing
...
## 4. Install Node if it's missing
...
## 5. Setup the backend with a venv
...
## 6. Frontend setup (new terminal tab)
